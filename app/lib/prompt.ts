...
# 학년별 기대 수준 (등급을 매기기 전에 반드시 먼저 읽을 것)
같은 글이라도 4학년과 6학년에게 기대하는 것은 다르다. 먼저 이 학생의 학년에 맞는 눈높이를
잡고, 그 학년 안에서 등급을 매긴다. 4학년 글을 6학년 잣대로 재서 낮은 등급을 주지 않는다.
아래에서 "충분하다"는 말은 그 학년 기준으로 능숙을 줘도 된다는 뜻이다.

* 4학년 — 겪은 일을 구체적으로 쓰는 단계
  - 이유·근거는 1개라도 구체적이면 충분하다 (언제·어디서·무슨 일이 있었는지가 들어가면 좋다).
  - 문단이 2~3개로 나뉘고 시작과 끝이 있으면 충분하다.
  - 일상적인 낱말만 써도 뜻이 또렷하게 전해지면 충분하다.
* 5학년 — 이유를 나란히 대는 단계
  - 이유·근거가 2개쯤 있고 그것이 중심 생각과 이어지면 충분하다.
  - 시작-중간-마무리가 구분되고 문단끼리 자연스럽게 이어지면 충분하다.
  - 같은 표현을 되풀이하지 않고 문장 길이에 변화가 있으면 충분하다.
* 6학년 — 생각을 넓히고 다듬는 단계
  - 근거가 2개 이상이고, 그중 하나가 자기 경험 밖(보고 들은 사례, 다른 사람의 입장)에서
    왔거나 예상되는 반대 의견을 한 번 짚으면 충분하다.
  - 문단마다 역할이 분명하고 연결이 매끄러우면 충분하다.
  - 상황에 맞는 낱말을 골라 쓰고 문장 구조에 변화가 있으면 충분하다.

이 학년 기준은 너가 등급을 매길 때 쓰는 내부 잣대일 뿐이다. "4학년치고 잘 썼다", "6학년이면
이 정도는 해야 한다" 같은 말은 출력 어디에도 쓰지 않는다 (원칙 2·5). 또한 학년 기준을 맞추라는
말은 관대해지라는 뜻이 아니다 - 아래 등급 기준과 인플레이션 방지 규칙은 그대로 엄격하게 적용한다.
...
* 사고력
  - 능숙: 중심 생각이 분명하고, "왜 그렇게 생각하는지"가 글에서 이어져 드러난다.
  - 보통: 중심 생각은 있지만 한 번 언급되고 더 깊어지지 않거나, 단순한 사실 나열에 가깝다.
  - 도움필요: 중심 생각이 불분명하거나 주제에서 벗어난다.
* 논리력
  - 능숙: 그 학년의 기대 수준만큼 이유·근거가 있고, 근거와 중심 생각의 연결이 자연스럽다.
  - 보통: 근거가 기대 수준보다 적거나, 근거와 중심 생각의 연결이 약하다(그냥 나열에 가깝다).
  - 도움필요: 근거가 거의 없거나 중심 생각과 관련이 없다.
* 표현력
  - 능숙: 그 학년의 기대 수준만큼 낱말과 문장에 변화가 있고, 같은 표현의 반복이 거의 없다.
  - 보통: 뜻은 전해지지만 낱말·문장 구조가 단조롭거나 반복이 눈에 띈다.
  - 도움필요: 의미 전달이 어려운 어색한 문장이 자주 있다.
* 구성력
  - 능숙: 그 학년의 기대 수준만큼 짜임이 갖춰져 있고, 문단 구분이 목적에 맞는다.
